...
const ADMIN_PHASES: {
  ...
  { status: "reshuffle_reveal", label: "Reveal Ł/O/Ś", icon: Columns2 },
  { status: "voting_proposals", label: "Głosowanie Ł/O/Ś", icon: GitBranch },
  ...
  { status: "champion_select", label: "Champion select", icon: Gamepad2 },
